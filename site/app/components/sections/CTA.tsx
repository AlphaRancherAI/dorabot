    ...
    <section className="relative overflow-hidden border-t border-border px-4 py-24 sm:px-8 sm:py-32 lg:px-12">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <ScrollReveal delay={0.25} className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a href="https://github.com/AlphaRancherAI/jarvis/releases/latest">
          ...
          <a href="https://github.com/AlphaRancherAI/jarvis" className="flex items-center gap-2 text-sm text-text hover:text-accent transition-colors">
            <GithubIcon />
            View on GitHub
          </a>
        </ScrollReveal>
