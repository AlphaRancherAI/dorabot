...
1. `~/.jarvis/workspace/USER.md` — who this person is
2. `~/.jarvis/workspace/SOUL.md` — who you should be for them
...
```
Read ~/.jarvis/workspace/USER.md
Read ~/.jarvis/workspace/SOUL.md
```
...
after gathering enough, write `~/.jarvis/workspace/USER.md` using this structure:
...
2-3 rounds of AskUserQuestion here. then write `~/.jarvis/workspace/SOUL.md`. keep it short and punchy — this isn't a constitution, it's a personality sketch. aim for 5-10 lines of actual guidance.
...
- remind them they can edit these anytime in the Soul tab or directly at `~/.jarvis/workspace/`
